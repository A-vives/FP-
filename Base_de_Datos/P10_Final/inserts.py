...
def insert_data_in_list(data_list):
...
VALUES
    ...
    ('Install Softw', 'Installing Software', 29.99),
    ('Mantenimence', 'Cleaning and mantenimence', 80.00),
    ('Kill Patologies', 'Kill Virus and malware', 99.00),
    ...
    ('Hardware Upgrade', 'Upgrade components for better performance', 129.00),
