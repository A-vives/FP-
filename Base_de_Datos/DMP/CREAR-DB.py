...
#     commands.append("INSERT INTO num numbers VALUES (" + num + ")")
# conn = None
...
# # Esto se ejecuta cur.execute(sql, tuple(list)) me cambia la lista en tupla
# sql = "INSERT INTO numbers num VALUES (%s), (%s), (%s), (%s), (%s),"
# list = []
# while len(list) < 5:
